...
export default () => {
  ...
  return (
    <React.Fragment>
      <ProCard split='vertical' className={styles.situation} gutter={[32, 16]}>
        <ProCard
          title='电仓情况'
          colSpan={{ xs: 0, sm: 0, md: 12, lg: 12, xl: 8, xxl: 6 }}
          layout='center'
          bordered
        ...
        >
          <Row gutter={[48, 48]} className={styles.row}>
            <Col span={12}>
              <Statistic
                value={electricWarehouse.roomTemperature}
                title='室内温度：'
                suffix='℃'
                layout='horizontal'
              />
            ...
            <Col span={12}>
              <Statistic
                value={electricWarehouse.indoorHumidity}
                title='室内湿度：'
                layout='horizontal'
              />
            </Col>
          ...
          <Row gutter={[48, 48]} className={styles.row}>
            <Col span={12}>
              <Statistic
                value={electricWarehouse.current}
                title='电流：'
                suffix='A'
                layout='horizontal'
              />
            ...
            <Col span={12}>
              <Statistic
                value={electricWarehouse.remainingBatteryPower}
                title='电池剩余电量：'
                suffix='%'
                layout='horizontal'
              />
        ...
        <ProCard
          title='每日电量统计'
          colSpan={{ xs: 0, sm: 0, md: 0, lg: 0, xl: 0, xxl: 4 }}
          layout='center'
          bordered
        ...
        <ProCard
          title='电池情况'
          colSpan={{ xs: 0, sm: 0, md: 0, lg: 0, xl: 8, xxl: 7 }}
          layout='center'
          bordered
        ...
        <ProCard
          title='控制系统'
          colSpan={{ xs: 24, sm: 24, md: 12, lg: 12, xl: 8, xxl: 7 }}
          layout='center'
          bordered
